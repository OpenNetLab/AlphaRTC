...
class AlphaCcNetworkController : public NetworkControllerInterface {
 public:
  AlphaCcNetworkController(NetworkControllerConfig config,
                          AlphaCcConfig alpha_cc_config);
  ~AlphaCcNetworkController() override;
 ...
 private:
  ...
  RTC_DISALLOW_IMPLICIT_CONSTRUCTORS(AlphaCcNetworkController);
};
