...
def main():
    ...
    while num_steps < total_training_steps:
        ...
        try:
            ...
            num_steps += cmdtrain.main(app.stdout, app.stdin)
            print(f'\n\n\nFinished the training loop (cmdtrain.main). Total trained steps {num_steps}\n\n\n')
            end = time.time()
